function [Aberr_TF] = BesselAberration(Params,Lx,Ly,Nx,Ny)
...
Aperture((FreqSquare >= (sin(AngleMax) / lambda)^2)|(FreqSquare <= (sin(AngleMin) / lambda)^2)) = 0;
