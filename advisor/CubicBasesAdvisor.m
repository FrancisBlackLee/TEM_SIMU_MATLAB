function [zoneAxes, bases, convMat, cutoff] = CubicBasesAdvisor(cellLengths,...
    cellAngles, uvw)
%CubicBasesAdvisor.m provides under the preset rule the advised reoriented 
%zone axes, lattice vectors (bases) and the corresponding conversion matrix
%of the unit cell for cubic crystal system.
% Input:
