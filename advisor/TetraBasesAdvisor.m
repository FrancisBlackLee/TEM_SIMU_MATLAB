function [zoneAxes, bases, convMat, cutoff] = TetraBasesAdvisor(cellLengths,...
    cellAngles, uvw)
%TetraBasesAdvisor.m provides under the preset rule the advised reoriented 
%zone axes, lattice vectors (bases) and the corresponding conversion matrix 
%of the unit cell for tetragonal crystal system.
% Input:
