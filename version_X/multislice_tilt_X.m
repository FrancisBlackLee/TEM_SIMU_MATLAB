function [exitWave] = multislice_tilt_X(inciWave, KeV, Lx, Ly, transFuncs,...
    sliceDist, stackNum, tiltX, tiltY, projPotDir, fileExtension)
...
%   tiltX -- small tilt in x direction in mrad;
%   tiltY -- small tilt in y direction in mrad;
    ...
    case 9
        ...
        for sliceIdx = 1 : sliceNum
            shiftedPropKernels(:, :, sliceIdx) = ...
                fftshift(FresnelPropKernel_X(Lx, Ly, Nx, Ny, wavLen,...
                sliceDist(sliceIdx), tiltX, tiltY));
        end
